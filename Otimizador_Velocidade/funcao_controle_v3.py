...
def calcular_velocidade(b1, b2, b3, b4, velocidade_nominal=72000, min_modulacao=0.770, max_modulacao=1.0):
    """
    Recebe o nivel atual dos 4 pulmoes (%) e retorna o setpoint em CPH.
    Parametros otimizados via CMA-ES em 2026-08-05.
    """
    # --- Gatilhos de modulacao otimizados pelo algoritmo ---
    b2_lim = 33.09   # B2 abaixo disto -> iniciar reducao
    b3_lim = 68.32   # B3 acima disto  -> iniciar reducao
    b1_lim = 22.60   # B1 aproximando do corte -> reducao feedforward
    b4_lim = 88.31   # B4 aproximando do corte -> reducao feedforward
    ...
    b2_baixo  = rampa_trapezoidal(b2, -1, 0, b2_lim - 18.85, b2_lim)
    b2_normal = rampa_trapezoidal(b2, b2_lim - 18.85, b2_lim, 100, 101)
    b3_normal = rampa_trapezoidal(b3, -1, 0, b3_lim, b3_lim + 19.22)
    b3_alto   = rampa_trapezoidal(b3, b3_lim, b3_lim + 19.22, 100, 101)
    
    # --- Feedforward: Alerta antecipado dos Pulmoes Extremos ---
    b1_tendencia = rampa_trapezoidal(b1, -1, 0, b1_lim, b1_lim + 10.00)
