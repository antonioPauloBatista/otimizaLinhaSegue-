...
print(f"   ↳ Na simulação com IA   : {v_paradas} amostras")
print(f"   ↳ EVITADAS PELA IA      : {hist_stops_buffer - v_paradas} amostras ({((hist_stops_buffer - v_paradas)/max(1, hist_stops_buffer)*100):.1f}% de melhoria)")
